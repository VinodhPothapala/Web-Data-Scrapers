...
//		login(driver);
		...
		String keyWords[] = new String[] {"Trump"};
...
//		}
	...
	public static void login(WebDriver driver) throws InterruptedException{
		...
		Thread.sleep(2000);
		WebElement userTextField = driver.findElement(By.name("text"));
		//WebElement userTextField = driver.findElement(By.id("layers"));
		////*[@id="layers"]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div[2]/label/div/div[1]/div/span
		//WebElement userTextField = driver.findElement(By.name("css-901oao css-16my406 r-poiln3 r-bcqeeo r-qvutc0"));
	...
	public static void tweet(WebDriver driver,String tweetBody) throws InterruptedException{
		...
		System.out.println("tweetTextBox" + tweetTextBox);
		System.out.println("tweetBody" +tweetBody);
		if(tweetTextBox!=null)
